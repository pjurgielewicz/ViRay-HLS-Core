...
#pragma HLS INLINE
			...
			myType u = (vx + myType(1.0)) * myType(0.5); // TRANSFORM -1...1 -> 0...1
			myType v = (vy + myType(1.0)) * myType(0.5);

#else
			// TEST CASE: FOR SQUARES
			myType u = (localHitPoint[0] + myType(1.0)) * myType(0.5); // TRANSFORM -1...1 -> 0...1
			myType v = (localHitPoint[2] + myType(1.0)) * myType(0.5);
#endif
